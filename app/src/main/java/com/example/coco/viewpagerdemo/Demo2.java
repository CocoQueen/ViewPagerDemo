    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loopViewPager.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Toast.makeText(Demo2.this, "position=" + position, Toast.LENGTH_SHORT).show();
            }
        });
        // 自定义动画
    ...
    private void initData() {
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            if (i == 2) {
                ...
                Glide.with(Demo2.this).load("http://pic.58pic.com/58pic/13/72/07/55Z58PICKka_1024.jpg").centerCrop().into(imageView);
                view = imageView;
            } else if (i == 4) {
                ImageView imageView = new ImageView(this);
                Glide.with(Demo2.this).load("http://www.bz55.com/uploads/allimg/120615/1-120615140A8.jpg").centerCrop().into(imageView);
                view = imageView;
            } else {
